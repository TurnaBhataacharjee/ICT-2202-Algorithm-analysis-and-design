...
public class ASPmain {
	...
	public static void main(String[] args) {
		...
		for(ActivitySelectionProblem act : list) {
			if(act.getStart()>=lastfinishtime) {
				System.out.println(act.getActivity() + " (Start: " + act.getStart() + ", Finish: " + act.getFinish() + ")");
				lastfinishtime=act.getFinish();
			}
